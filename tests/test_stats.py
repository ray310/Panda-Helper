...
class TestStats:
    ...
    def test_frequency_table_valid(self, num_series):
    ...
    def test_frequency_table_invalid(self, non_series_invalid, test_df):
    ...
    def test_abbreviate_string_correct(self):
    ...
    def test_abbreviate_string_invalid(
        self, non_series_invalid, test_df, cat_like_series
    ):
    ...
    def test_distribution_stats(self, num_series, full_stats):  # pylint: disable=W0621
        """distribution_stats returns 1-column pd.DataFrame with
        correctly ordered stats.
        """
    ...
    def test_dist_stats_dict(self, num_series):
    ...
    def test_dist_stats_dict_int_float(self, full_stats):  # pylint: disable=W0621
    ...
    def test_dist_stats_dict_complex(self):
    ...
    def test_dist_stats_dict_timestamp(self):
    ...
    def test_dist_stats_dict_timedelta(self):
    ...
    def test_dist_stats_dict_period(self):
    ...
    def test_dist_stats_dict_interval(self):
    ...
    def test_dist_stats_dict_invalid(
        self, non_series_invalid, test_df, cat_like_series
    ):
